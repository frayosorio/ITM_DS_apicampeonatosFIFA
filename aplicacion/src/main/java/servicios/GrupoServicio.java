...
public class GrupoServicio implements IGrupoServicio {
    ...
    public List<TablaPosicionDto> listarTablaPosiciones(int idGrupo){
        List<TablaPosicionDto> tablaPosiciones = em.createNativeQuery("SELECT * FROM fObtenerTablaPosiciones(:idgrupotabla)", TablaPosicionDto.class)
